          ...
          <section className="py-10 flex flex-col gap-y-5">
            ...
            <div className="flex md:flex-row xs:flex-col gap-3">
              <aside className="xs:w-full md:w-1/5 p-2 flex flex-col gap-y-4 overflow-y-scroll relative">
                <h2 className="font-bold text-xl xs:border xs:border-black/30 md:border-none w-fit p-2 rounded-lg xs:text-base text-black/30 hover:text-black duration-200 transition-all cursor-pointer xs:ml-8 md:ml-0 select-none" onClick={() => setRevealSideBar(true)}>
                  Filter
                </h2>
